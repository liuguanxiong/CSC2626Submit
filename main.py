...
from dataset_check import CarlaH5Dataset
...
parser.add_argument('--train-dir', default="./data/SeqTrain/",
                    type=str, metavar='PATH',
                    help='training dataset')
parser.add_argument('--eval-dir', default="./data/SeqVal/",
                    type=str, metavar='PATH',
...
def main():
    ...
    branch_losses_list, speed_losses_list, losses_list, prec_list = [], [], [], []
    ...
    if args.resume:
        ...
        if os.path.isfile(args.resume):
            ...
            branch_losses_list = checkpoint['branch_losses']
            speed_losses_list = checkpoint['speed_losses']
            losses_list = checkpoint['total_losses']
            prec_list = checkpoint['precs']
    ...
    train_loader = torch.utils.data.DataLoader(CarlaH5Dataset(data_dir=args.train_dir,
                                                train_eval_flag="train"),
                                                batch_size=args.batch_size,
                                                num_workers=args.workers,
                                                pin_memory=True,
                                                shuffle=True)
    eval_loader = torch.utils.data.DataLoader(CarlaH5Dataset(data_dir=args.eval_dir,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        branch_losses_list.append(branch_losses)
        speed_losses_list.append(speed_losses)
        ...
        save_checkpoint(
            {'epoch': epoch + 1,
             ...
             'branch_losses': branch_losses_list,
             'speed_losses': speed_losses_list,
             'total_losses':losses_list,
             'precs':prec_list
             },
            args.id,
            is_best,
